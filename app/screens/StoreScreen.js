                ...
                <SectionList
                    ...
                    renderItem={({ item: product }, i) => (
                        (<ProductCell
                            product={product}
                            onPress={() => {
                                navigation.navigate({ key: screenNames.ProductStack, routeName: screenNames.ProductStack, params: { store_id: store.id, order_product: { product: product }, title: store.name } })
                            }}
                        />)
                    )}
                    ListHeaderComponent={() => (
